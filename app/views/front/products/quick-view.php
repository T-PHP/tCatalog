    ...
    <div class="container-fliud">
        <div class="wrapper row">
            ...
            <div class="details col-xs-12 col-md-6">
                ...
                <p class="product-description"><?= $data['product'][0]->short_description; ?></p>
                
                <form class="">
                    <h4 class="price"><?= Language::show('Current Price', 'Products'); ?> : <span>$<?= number_format($data['product'][0]->price, 2); ?></span></h4>
                    <p class="vote"><strong>91%</strong> of buyers enjoyed this product! <strong>(87 votes)</strong></p>
                    <!-- Attributes -->
                    <?php foreach($data['attributes_groups'] as $attribute_group): ?>
                        <div class="form-group">
                            <label class="attribute-label control-label" for="<?= $attribute_group['id_attribute_group']; ?>"><?= $attribute_group['group_name']; ?></label>
