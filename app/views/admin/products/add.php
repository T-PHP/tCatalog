...
<div class="content-wrapper">
    <section class="content-header">
      <h1>
        <?php echo Language::showAdmin('Add product', 'Products'); ?>
      </h1>
      <ol class="breadcrumb">
        ...
        <li class="active"><?php echo Language::showAdmin('Add', 'Products'); ?></li>
      </ol>
    </section>
      ...
      <div class="row">
        ...
        <div class="col-xs-12 col-md-4">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="form-group">
                      <label for="brand"><?php echo Language::showAdmin('Brands', 'Products'); ?></label>
            ...
            <div class="box">
                ...
                <div class="box-footer">
                    ...
                    <button type="submit" name="addProduct" class="btn btn-primary"><?php echo Language::showAdmin('Save', 'Products'); ?></button>
                </div>
            </div><!-- /.box SEO -->
        </div><!-- /.col -->
        <?php echo Form::close(); ?>
