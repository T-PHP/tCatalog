...
class Language
{
    ...
    {
        /* lang file */
        $file = SMVC."app/language/front/$code/$name.php";
        ...
        if (is_readable($file)) {
            ...
            /* display error */
            echo Error::display("Could not load language file Front '$code/$name.php'");
            die;
        }
    }
    
    public function loadAdmin($name, $code = LANGUAGE_CODE_ADMIN)
    {
        /* lang file */
        $file = SMVC."app/language/admin/$code/$name.php";
        ...
        if (is_readable($file)) {
            ...
            /* display error */
            echo Error::display("Could not load language file Admin '$code/$name.php'");
            die;
        }
    }
    ...
    public static function showAdmin($value, $name, $code = LANGUAGE_CODE_ADMIN)
    {
        /* lang file */
        $file = SMVC."app/language/admin/$code/$name.php";
