...
class View
{
    ...
    public static function render($path, $data = false, $error = false)
    {
        ...
        require SMVC."app/views/front/$path.php";
    }
    ...
    public static function renderAdmin($path, $data = false, $error = false)
    {
        ...
        require SMVC."app/views/admin/$path.php";
    }
    ...
    public static function renderTemplateAdmin($path, $data = false, $custom = TEMPLATE)
    {
        self::sendHeaders();

        require SMVC."app/templates/admin/$path.php";
    }
